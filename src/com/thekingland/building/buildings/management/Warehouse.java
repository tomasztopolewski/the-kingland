package com.thekingland.building.buildings.management;
...
public class Warehouse extends Building implements EssentialsBuilding, BuildingWithStaticSquare {
    ...
    public Warehouse(int levelUpgrade) throws FileNotFoundException {
        ...
        classLoadFileMaterialOfSpace  = new ClassLoadFile("materials-space", "D:\\OneDrive\\The KingLand\\The KingLand\\File\\games\\Player");
